...
CREATE TABLE `cfcr_court` (
  ...
  `court_fee` decimal(10,0) DEFAULT NULL COMMENT '场地费用',
  `court_vip` tinyint DEFAULT NULL COMMENT '是否为VIP场地（0，否，1是）',
  PRIMARY KEY (`court_id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='场地表';
...
INSERT INTO `cfcr_court` VALUES (1,6,NULL,100,1,100,1),(6,6,NULL,102,1,11,1),(7,6,NULL,103,1,12,1),(8,3,NULL,109,1,10,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='羽毛球场预约表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cfcr_reservation` VALUES (1,1,6,NULL,'2024-03-04 16:00:00','2024-03-06 16:00:00',NULL),(2,1,8,NULL,'2024-03-05 17:00:00','2024-03-05 18:00:00',NULL);
...
INSERT INTO `cfcr_venue` VALUES (3,'三星场馆','南大街','89878856','十分的好',0,0),(4,'四星场馆','11','11',NULL,1,1),(6,'五星场馆','西大街','102909837488','真的特别好',0,0),(7,'一星场馆','南外环','1098987668','描述',1,1);
...
) ENGINE=InnoDB AUTO_INCREMENT=118 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='系统访问记录';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `sys_notice` VALUES (1,'温馨提醒：2018-07-01 若依新版本发布啦','2',_binary '新版本内容','0','admin','2024-02-28 22:23:43','',NULL,'管理员'),(2,'维护通知：2018-07-01 若依系统凌晨维护','1',_binary '维护内容','0','admin','2024-02-28 22:23:43','',NULL,'管理员');
...
INSERT INTO `sys_role` VALUES (1,'超级管理员','admin',1,'1',1,1,'0','0','admin','2024-02-28 22:23:42','',NULL,'超级管理员'),(2,'教练员','coach',2,'2',1,1,'0','0','admin','2024-02-28 22:23:42','admin','2024-02-28 22:40:47','教练员'),(100,'VIP用户','VIP',3,'1',1,1,'0','0','admin','2024-02-28 22:41:12','',NULL,NULL),(101,'普通用户','common',4,'1',1,1,'0','0','admin','2024-02-28 22:41:32','',NULL,'普通用户');
...
INSERT INTO `sys_user` VALUES (1,100,'admin','管理员','00','ry@163.com','15888888888','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','0','127.0.0.1','2024-03-04 18:53:25','admin','2024-02-28 22:23:42','','2024-03-04 18:53:25','管理员'),(2,105,'ry','若依','00','ry@qq.com','15666666666','1','','$2a$10$7JB720yubVSZvUI0rEqK/.VqGOZTH.ulu33dHOiBE8ByOhJIrdAu2','0','2','127.0.0.1','2024-02-28 22:23:42','admin','2024-02-28 22:23:42','',NULL,'测试员'),(100,100,'zhangsan','张三','00','','13089876578','0','','$2a$10$g86PdbK5Z28hgOkGfevFCuO0KekkjR6OJdAHt8gCyLJFG3Uos.3JO','0','0','',NULL,'admin','2024-03-04 18:58:34','',NULL,NULL),(101,100,'lisi','李四','00','','13909879876','0','','$2a$10$aiYx9RhkHXWto9AK.rMgu.MobzG6j76WtZ5jetHTmi67xJjcZ9tZq','0','0','',NULL,'admin','2024-03-04 18:58:57','',NULL,NULL),(102,100,'wangwu','王五','00','','13809897654','1','','$2a$10$fvHIaJ0kOyCPYIFlo6Tnn.juTWodmgWP6IT/9D6qzI77zT6hhLNGS','0','0','',NULL,'admin','2024-03-04 18:59:22','',NULL,NULL),(103,100,'zhaoliu','赵六','00','','13098987678','1','','$2a$10$W/Jh9aLcunw7wGAFa7GSuOcNroWzbk5Dy4AXPb7Ke85BIJdsEQNrC','0','0','',NULL,'admin','2024-03-04 18:59:55','',NULL,NULL);
...
-- Dump completed on 2024-03-04 20:56:06
