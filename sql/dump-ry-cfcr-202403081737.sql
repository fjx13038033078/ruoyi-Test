...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='可购买运动器材表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cfcr_equipment_purchase` VALUES (3,4,1,10,10.00),(4,4,2,1,100.00),(5,4,4,10,100.00),(6,3,0,10,10.00);
...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='商品维修表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='羽毛球场预约表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `cfcr_reservation` VALUES (1,1,6,100,'2024-03-04 16:00:00','2024-03-06 16:00:00',1),(2,1,8,101,'2024-03-05 17:00:00','2024-03-05 18:00:00',1),(3,1,8,NULL,'2024-03-05 16:00:00','2024-03-05 17:00:00',1),(4,1,1,100,'2024-03-06 16:00:00','2024-03-06 17:00:00',1),(5,1,6,NULL,'2024-03-06 18:00:00','2024-03-06 19:00:00',1),(6,102,7,NULL,'2024-03-05 16:00:00','2024-03-05 17:00:00',1),(7,1,6,101,'2024-03-07 22:00:00','2024-03-08 01:00:00',0);
...
INSERT INTO `sys_role` VALUES (1,'超级管理员','admin',1,'1',1,1,'0','0','admin','2024-02-28 22:23:42','',NULL,'超级管理员'),(2,'教练员','coach',2,'2',1,1,'0','0','admin','2024-02-28 22:23:42','admin','2024-03-07 17:44:43','教练员'),(100,'VIP用户','VIP',3,'1',1,1,'0','0','admin','2024-02-28 22:41:12','admin','2024-03-07 17:44:35',NULL),(101,'普通用户','common',4,'1',1,1,'0','0','admin','2024-02-28 22:41:32','admin','2024-03-07 17:45:02','普通用户');
...
INSERT INTO `sys_role_menu` VALUES (2,2000),(2,2001),(2,2002),(2,2003),(2,2005),(2,2006),(2,2013),(100,2000),(100,2001),(100,2002),(100,2003),(100,2005),(100,2006),(100,2009),(100,2010),(100,2012),(100,2013),(100,2016),(101,2000),(101,2001),(101,2002),(101,2003),(101,2005),(101,2006),(101,2010),(101,2012),(101,2013),(101,2016);
...
-- Dump completed on 2024-03-08 17:37:40
